...
In this chapter, we will learn to work with string data in R using [stringr](https://stringr.tidyverse.org). As we did in the other chapters, we will use a case study to explore the various features of the stringr package. 
