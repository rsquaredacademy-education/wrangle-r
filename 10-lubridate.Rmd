...
## Introduction
 ...
 In this chapter, we will learn to work with date/time data in R using 
 [lubridate](https://lubridate.tidyverse.org/), an R package that makes it easy 
 to work with dates and time. We will use the following R packages:
...
```{r showf, echo=FALSE, eval=TRUE, message=FALSE}
transact <- read_csv('https://raw.githubusercontent.com/rsquaredacademy/datasets/master/transact.csv')
transact
```
...
We will use the lubridate package to answer a few questions we have about the 
transact data.
...
```{r img1d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img2d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img3d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img4d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img6d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img5d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img7d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img8d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img9d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img10d, echo=FALSE, out.width="100%", fig.align="center"}
...
```{r img11d, echo=FALSE, out.width="100%", fig.align="center"}
